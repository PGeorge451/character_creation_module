...
def attack(char_name, char_class):
    """Функция расчитает значение урона персонажа при атаке."""
...
def defence(char_name, char_class):
    ...
    Функция расчитает значение блока
    персонажа при защите.
    """
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Документация функции.
    Функция расчитает результат применения
    спецнавыка персонажа.
    """
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Документация функции.
    Функция выводит описание класса персонажа и
    предлагает выбор действий.
    """
    if char_class == 'warrior':
...
def choice_char_class():
    """Документация функции.
    Функция выводит описание классов и
    предлагает выбор класса персонажа.
    """
    approve_choice = None
    char_class = None
